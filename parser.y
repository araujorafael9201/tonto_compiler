...
%token GENSET DISJOINT COMPLETE GENERAL SPECIFICS WHERE PACKAGE IMPORT FUNCTIONAL_COMPLEXES DATATYPE SPECIALIZES ENUM RELATION NUMBER CLASS_ESTEREOTYPE RELATIONSHIP_ESTEREOTYPE NATIVE_DATA_TYPE NEW_DATA_TYPE META_ATTR CLASS_ID RELATIONSHIP_ID INSTANCE_ID L_BRACE R_BRACE L_PARENTHESIS R_PARENTHESIS L_BRACKET R_BRACKET TP LRO RRO ASTERISK AT COLON
